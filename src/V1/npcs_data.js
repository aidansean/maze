var npcs = [] ;
var npc_gerald = new npc_object('Gerald', 0, 0, 5, 5, 'red', 'white') ;
npc_gerald.dialogue.push(['Hello there!']) ;
npc_gerald.dialogue.push([['My name is Gerald, and I like grapes.',0], ['What?',2], ['Oh',2], ['My face hurts',2]]) ;
npc_gerald.dialogue.push(['I saw a hedge once.',[3]]) ;
npc_gerald.dialogue.push(['It\'s true.',[2]]) ;
npc_gerald.dialogue_preamble.push('What what? (press space to continue the conversation)') ;

var npc_gertrude = new npc_object('Gertrude', 0, 0, 3, 3, 'brown', 'pink') ;
...
var npc_glados = new npc_object('GLaDOS', 0, 0,10, 3, 'orange', '#ffdddd') ;
