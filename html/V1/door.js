  ...
  this.draw = function(flag){
    ...
    if(player.A==this.A1 && player.B==this.B1){
      ...
      if(flag==1){
        ...
        var th = 8 ;
        var lw = cellSize-2*th ; // lever width
        var lh = th ; // lever height
        if(true){
          if(this.dir=='N'){
            context.fillStyle = wall_edge_color ;
            context.fillRect(this.i1*cellSize,this.j1*cellSize,cellSize,cellSize) ;
            context.fillStyle = wall_fill_color ;
            context.fillRect(this.i1*cellSize+th,this.j1*cellSize-th,cellSize-2*th,th) ;
          }
          else if(this.dir=='E'){
            context.fillRect((this.i1+1)*cellSize-lh,(this.j1+0)*cellSize+th,lh,lw) ;
          }
          else if(this.dir=='S'){
            context.fillStyle = wall_edge_color ;
            context.fillRect(this.i1*cellSize,this.j1*cellSize,cellSize,cellSize) ;
            context.fillStyle = 'red' ; //wall_fill_color ;
            context.fillRect(this.i1*cellSize+th,this.j1*cellSize-th,cellSize-2*th,th) ;
            
            if(false){
              context.strokeStyle = 'magenta' ;
              context.beginPath() ;
              context.moveTo((this.i1+0.5)*cellSize,this.j1*cellSize-th) ;
              if(this.door_status==1){
                context.lineTo(this.i1*cellSize-2*th,this.j1*cellSize) ;
              }
              if(this.door_status==1){
                context.lineTo(this.i1*cellSize+2*th,this.j1*cellSize) ;
              }
            ...
            context.fillRect((this.i1+0)*cellSize,(this.j1-0)*cellSize+th,lh,lw) ;
          }
        }
